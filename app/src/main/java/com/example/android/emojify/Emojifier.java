...
class Emojifier {
    ...
    static void detectFaces(Context context, Bitmap picture) {
        ...
        for (int i=0; i<faces.size();i++){
            Log.v(LOG_TAG,"Face- " + flag+". Right eye = "+getClassification(faces.get(i))[0]+
                    ". Left eye = "+getClassification(faces.get(i))[1]+
                    ". Smiling = "+getClassification(faces.get(i))[2]);
            flag ++;
        }
    ...
    static float[] getClassification(Face face) {
