...
class Emojifier {
        ...
        if(faces.size() == 0){
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                if (face != null) {
                    ...
                    Toast.makeText(context, "Make another foto, please бля", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private static void whichEmoji(Face face){
        ...
        float s = face.getIsSmilingProbability();
        // Log all the probabilities
        Log.d(LOG_TAG, "getClassifications: smilingProb = " + s);
        Log.d(LOG_TAG, "getClassifications: leftEyeOpenProb = " + l);
        Log.d(LOG_TAG, "getClassifications: rightEyeOpenProb = " + r);
